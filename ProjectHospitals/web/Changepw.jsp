<%-- 
    ...
    Created on : Feb 7, 2023, 12:42:38 AM
    Author     : Le Duong
--%>
...
<html>
    <head>
        ...
        <link href="style/changepw.css" rel="stylesheet" />
                            ...
                            <div class="card-body p-md-5">
                                <div class="row justify-content-center">
                                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        ...
                                        <form class="mx-1 mx-md-4" action="changepw" method="post">
                                            ...
                                            <div class="d-block mx-4 mb-3 mb-lg-4  text-danger"><b>${error}</b></div>
